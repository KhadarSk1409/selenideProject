...
public class XmlReportGeneratingListener implements TestExecutionListener {
	...
	public XmlReportGeneratingListener(Path reportsDir, PrintWriter out) {
		this(reportsDir, out, Clock.systemDefaultZone());
	}

	// For tests only
	XmlReportGeneratingListener(String reportsDir, PrintWriter out, Clock clock) {
		this(Paths.get(reportsDir), out, clock);
	}

	private XmlReportGeneratingListener(Path reportsDir, PrintWriter out, Clock clock) {
